...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Monthly Extract for call activity 2ndwed', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Monthly Extract for call activity 2ndwed', 
		@step_id=1, 
...
exec [BMSRData_CSCAN]..sp_backup_table ''BMSRData_CSCAN_Backup'',''Test_Prateek'', ''CurrentWeekTable_forcallactivityextract''
