...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'1APS_DCV_ZEP_ Daily Pat Hub Feed', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'run daily 6 pm', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=62, 
		@freq_subday_type=1, 
		...
		@active_start_time=163001, 
		@active_end_time=235959, 
		@schedule_uid=N'1f7fb486-8f62-44a9-8f42-bab3ae806e5b'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
